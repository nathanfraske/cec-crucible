...
pub const BORDER: Color = Color::Rgb(140, 103, 242); // bright outlines (--violet)
...
pub const VALUE: Color = Color::Rgb(65, 217, 248); // the number that matters (--vpop-cyan)
...
pub const CAT_CPU: Color = Color::Rgb(159, 156, 255); // lavender (--vpop-label)
pub const CAT_GPU: Color = Color::Rgb(237, 35, 152); // brand pink (flagship)
